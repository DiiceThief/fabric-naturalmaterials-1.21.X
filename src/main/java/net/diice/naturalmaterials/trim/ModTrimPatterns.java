...
public class ModTrimPatterns {
    public static final RegistryKey<ArmorTrimPattern> HUNTER = RegistryKey.of(RegistryKeys.TRIM_PATTERN,
            Identifier.of(NaturalMaterials.MOD_ID, "hunter"));

    public static void bootstrap(Registerable<ArmorTrimPattern> context) {
        register(context, ModItems.HUNTER_SMITHING_TEMPLATE, HUNTER);
    }
