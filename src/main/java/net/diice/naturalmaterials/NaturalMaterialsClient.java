...
public class NaturalMaterialsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.POTTED_CYPRESS_SAPLING, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.POTTED_REDWOOD_SAPLING, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.POTTED_MANAWOOD_SAPLING, RenderLayer.getCutout());

        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GLOOMWOOD_LEAVES, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GLOOMWOOD_SAPLING, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.POTTED_GLOOMWOOD_SAPLING, RenderLayer.getCutout());
